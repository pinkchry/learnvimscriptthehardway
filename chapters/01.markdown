...
Read [`:help echo`][echo].
[echo]: http://vimdoc.sourceforge.net/search.php?docs=help&search=echo
Read [`:help echom`][echom].
[echom]: http://vimdoc.sourceforge.net/search.php?docs=help&search=echom
Read [`:help messages`][messages].
[messages]: http://vimdoc.sourceforge.net/search.php?docs=help&search=messages
